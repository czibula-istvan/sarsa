...
public abstract class RectangularTopology implements SOMTopology {
	...
	protected void initminDistance() {
		if (getNrNeurons() < 2) {
			...
			minDist = dist.distance(getNeuron(0).getNeuronPosition(), getNeuron(1).getNeuronPosition());
		}
	}
	...
	public double getMaxRadius() {
		return dist.distance(neurons[0][0].getNeuronPosition(), neurons[row - 1][column - 1].getNeuronPosition());
	}
