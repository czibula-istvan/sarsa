...
public class MetricUtils {
	...
	public static <T> double computeAverageObjectDistance(double[] clusterCentre, Cluster<T> clus,
			VectorModelProvider<T> vectModel) {
		return computeAverageObjectDistance(clusterCentre, clus.getAll(), vectModel, dist);
	}

	public static <T> double computeAverageObjectDistance(double[] clusterCentre, List<T> clus,
	...
	public static <T> double[] computeClusterCenter(Cluster<T> clus, VectorModelProvider<T> vectModel) {
		return computeClusterCenter(clus.getAll(), vectModel, dist);
	}

	public static <T> double computeAvgDistanceToCenter(List<T> objs, VectorModelProvider<T> vectModel) {
		double[] center = computeClusterCenter(objs, vectModel, dist);
		return computeAverageObjectDistance(center, objs, vectModel, dist);
	}

	public static <T> double[] computeClusterCenter(List<T> objs, VectorModelProvider<T> vectModel) {
